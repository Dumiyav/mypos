    ...
    <div class="h-full flex flex-col">
        ...
        <nav class="flex-1 overflow-y-auto">
            <ul class="px-2 py-4">
                ...
                <?php if (hasPermission($currentUser['role'], 'tables')): ?>
                <li class="mb-2">
                    <a href="index.php?page=tables" class="flex items-center px-4 py-2 rounded-lg <?php echo $currentPage == 'tables' ? 'bg-gray-900' : 'hover:bg-gray-700'; ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
